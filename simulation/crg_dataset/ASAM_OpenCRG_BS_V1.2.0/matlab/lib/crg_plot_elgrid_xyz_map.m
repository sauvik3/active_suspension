...
% CRG_PLOT_ELGRID_XYZ_MAP Plot z-values as curved 3-dimensional image.
%   DATA = CRG_PLOT_ELGRID_XYZ_MAP(DATA, IU, IV) plots z-values as
...
%
% package:               lib
% file name:             crg_plot_elgrid_xyz_map.m 
% author:                ASAM e.V.
%
%
% C by ASAM e.V., 2020
...
%% plot elevation grid XYZ perspective map
