    ...
    for s_idx = 1:numel(speeds_mps)
        ...
        try
            ...
            if ~isempty(sim_sprung_accel) && length(sim_sprung_accel) > 1
                ...
                features_struct = extract_road_features(sim_sprung_accel, resolution);

                features_vector = [features_struct.Mean, features_struct.Std, features_struct.Variance, ...
                                   features_struct.Max, features_struct.Min, features_struct.RMS, ...
                                   features_struct.Skewness, features_struct.Kurtosis, features_struct.Energy, ...
                                   features_struct.PeakToPeak, features_struct.CrestFactor];
        ...
        catch ml_adaptive_err
            warning(ml_adaptive_err.identifier, 'ML Adaptive gain processing/simulation failed for %s at %.1f km/h: %s', ...
                                ctrl, current_speed_kmh, ml_adaptive_err.message);
